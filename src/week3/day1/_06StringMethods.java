...
//        not recommended:
        ...
        System.out.println(name == name3); // <- овтет false, потому что хоть и данные("Дима") одинаковые, но ссылки на них разные, а таким образом будут сравниваться ссылки на данные, а не сами данные.
